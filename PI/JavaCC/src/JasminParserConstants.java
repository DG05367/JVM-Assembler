...
public interface JasminParserConstants {
    public enum TokenType {
        EOF, WHITESPACE, INTEGER, LONG, CLASS, PUBLIC, SUPER, SEMICOLON, LINE_COMMENT, DOUBLE_DOT, DOT, METHOD, DOT_METHOD, END, STATIC, INT, VOID, ARRAY_IDENTIFIER, LIMIT, SLASH, OPEN_PAREN, CLOSE_PAREN, LESS, GREAT, LOCALS, STACK, GO_TO, GO_TO_W, A_NEW_ARRAY, ARRAY_LENGTH, ARETURN, AALOAD, AASTORE, ACONST_NULL, ALOAD, ALOAD_0, ALOAD_1, ALOAD_2, ALOAD_3, BALOAD, CALOAD, CASTORE, CHECKCAST, D2F, D2I, D2L, DADD, DALOAD, DASTORE, DCMPG, DCMPL, DCONST_0, DCONST_1, DDIV, DLOAD, DLOAD_0, DLOAD_1, DLOAD_2, DLOAD_3, DMUL, DNEG, DREM, DRETURN, DSTORE, DSTORE_0, DSTORE_1, DSTORE_2, DSTORE_3, DSUB, DUP, DUP_X1, DUP_X2, DUP2, DUP2_X1, DUP2_X2, F2D, ATHROW, ASTORE, ASTORE_1, ASTORE_2, ASTORE_3, BASTORE, ICONST, ICONST_0, ICONST_1, ICONST_2, ICONST_3, ICONST_4, ICONST_5, ISTORE, ISTORE_1, ISTORE_2, ISTORE_3, ILOAD, ILOAD_0, ILOAD_1, ILOAD_2, ILOAD_3, IF_ACMPEQ, IF_ACMPNE, IF_ICMPEQ, IF_ICMPNE, IF_ICMPLT, IF_ICMPGE, IF_ICMPGT, IF_ICMPLE, IFEQ, IFNE, IFLT, IFGE, IFGT, IFLE, IFNONNULL, IFNULL, IADD, IINC, NEW, BIPUSH, F2I, F2L, FADD, FALOAD, FASTORE, FCMPG, FCMPL, FCONST, FCONST_0, FCONST_1, FCONST_2, FCONST_3, FDIV, FLOAD, FLOAD_0, FLOAD_1, FLOAD_2, FLOAD_3, FMUL, FNEG, FREM, FRETURN, FSTORE, FSTORE_0, FSTORE_1, FSTORE_2, FSTORE_3, FSUB, GETFIELD, GETSTATIC, I2B, I2C, I2D, I2F, I2L, I2S, IALOAD, IAND, IASTORE, IDIV, INEG, IMUL, INSTANCEOF, INVOKEDYNAMIC, INVOKEINTERFACE, INVOKESPECIAL, INVOKESTATIC, INVOKEVIRTUAL, INVOKENONVIRTUAL, IOR, IREM, ISHL, ISHR, ISUB, IUSHR, IXOR, JSR, JSR_W, L2D, L2F, L2I, LADD, LALOAD, LAND, LASTORE, LCMP, LCONST_0, LCONST_1, LDC, LDC_W, LDC2_W, LDIV, LLOAD, LLOAD_0, LLOAD_1, LLOAD_2, LLOAD_3, LMUL, LNEG, LOOKUPSWITCH, LREM, LRETURN, LSHL, LSHR, LOR, LSTORE, LSTORE_0, LSTORE_1, LSTORE_2, LSTORE_3, LSUB, LUSHR, LXOR, MONITORENTER, MONITOREXIT, MULTIANEWARRAY, NOP, POP, POP_2, PUTFIELD, PUTSTATIC, RET, SALOAD, SASTORE, SIPUSH, SWAP, TABLESWITCH, WIDE, IRETURN, RETURN, QUOTED, IDENTIFIER, INVALID
    }
    /**
   * Lexical States
   */
