...
public class Token implements JasminParserConstants, Node {
    ...
    public static Token newToken(TokenType type, JasminParserLexer tokenSource, int beginOffset, int endOffset) {
        switch(type) {
            ...
            case SUPER:
            return new SUPER(TokenType.SUPER, tokenSource, beginOffset, endOffset);
            case SEMICOLON:
            return new SEMICOLON(TokenType.SEMICOLON, tokenSource, beginOffset, endOffset);
            case DOUBLE_DOT:
            return new DOUBLE_DOT(TokenType.DOUBLE_DOT, tokenSource, beginOffset, endOffset);
            case METHOD:
            return new METHOD(TokenType.METHOD, tokenSource, beginOffset, endOffset);
            case END:
            return new END(TokenType.END, tokenSource, beginOffset, endOffset);
            case STATIC:
            ...
            case SLASH:
            return new SLASH(TokenType.SLASH, tokenSource, beginOffset, endOffset);
            case OPEN_PAREN:
            ...
            case GREAT:
            return new GREAT(TokenType.GREAT, tokenSource, beginOffset, endOffset);
            case LOCALS:
            return new LOCALS(TokenType.LOCALS, tokenSource, beginOffset, endOffset);
            case STACK:
            return new STACK(TokenType.STACK, tokenSource, beginOffset, endOffset);
            case LOOP:
            return new LOOP(TokenType.LOOP, tokenSource, beginOffset, endOffset);
            case ENDLOOP:
            return new ENDLOOP(TokenType.ENDLOOP, tokenSource, beginOffset, endOffset);
            case GO_TO:
            return new GO_TO(TokenType.GO_TO, tokenSource, beginOffset, endOffset);
            case ICONST_0:
            return new ICONST_0(TokenType.ICONST_0, tokenSource, beginOffset, endOffset);
            case ISTORE_2:
            return new ISTORE_2(TokenType.ISTORE_2, tokenSource, beginOffset, endOffset);
            case ISTORE_3:
            return new ISTORE_3(TokenType.ISTORE_3, tokenSource, beginOffset, endOffset);
            case ILOAD_1:
            return new ILOAD_1(TokenType.ILOAD_1, tokenSource, beginOffset, endOffset);
            case ILOAD_2:
            return new ILOAD_2(TokenType.ILOAD_2, tokenSource, beginOffset, endOffset);
            case ILOAD_3:
            return new ILOAD_3(TokenType.ILOAD_3, tokenSource, beginOffset, endOffset);
            case IF_ICMPGE:
            return new IF_ICMPGE(TokenType.IF_ICMPGE, tokenSource, beginOffset, endOffset);
            case IADD:
            return new IADD(TokenType.IADD, tokenSource, beginOffset, endOffset);
            case IINC:
            return new IINC(TokenType.IINC, tokenSource, beginOffset, endOffset);
            case IRETURN:
            return new IRETURN(TokenType.IRETURN, tokenSource, beginOffset, endOffset);
            case ALOAD_0:
            return new ALOAD_0(TokenType.ALOAD_0, tokenSource, beginOffset, endOffset);
            case INVOKENONVIRTUAL:
            return new INVOKENONVIRTUAL(TokenType.INVOKENONVIRTUAL, tokenSource, beginOffset, endOffset);
            case RETURN:
