...
public class JasminParserLexer implements JasminParserConstants {
    ...
    private BitSet nextStates= new BitSet(184), currentStates= new BitSet(184);
    EnumSet<TokenType> activeTokenTypes= EnumSet.allOf(TokenType.class);
     {
    }
    // Token types that are "regular" tokens that participate in parsing,
    // i.e. declared as TOKEN
    static final EnumSet<TokenType> regularTokens= EnumSet.of(TokenType.EOF, TokenType.INTEGER, TokenType.DOT, TokenType.CLASS, TokenType.PUBLIC, TokenType.SUPER, TokenType.SEMICOLON, TokenType.DOUBLE_DOT, TokenType.METHOD, TokenType.END, TokenType.STATIC, TokenType.INT, TokenType.VOID, TokenType.LIMIT, TokenType.SLASH, TokenType.OPEN_PAREN, TokenType.CLOSE_PAREN, TokenType.LESS, TokenType.GREAT, TokenType.LOCALS, TokenType.STACK, TokenType.LOOP, TokenType.ENDLOOP, TokenType.GO_TO, TokenType.ICONST_0, TokenType.ISTORE_2, TokenType.ISTORE_3, TokenType.ILOAD_1, TokenType.ILOAD_2, TokenType.ILOAD_3, TokenType.IF_ICMPGE, TokenType.IADD, TokenType.IINC, TokenType.IRETURN, TokenType.ALOAD_0, TokenType.INVOKENONVIRTUAL, TokenType.RETURN, TokenType.IDENTIFIER);
    ...
    static final EnumSet<TokenType> skippedTokens= EnumSet.of(TokenType._TOKEN_1, TokenType._TOKEN_2, TokenType._TOKEN_3, TokenType._TOKEN_4);
